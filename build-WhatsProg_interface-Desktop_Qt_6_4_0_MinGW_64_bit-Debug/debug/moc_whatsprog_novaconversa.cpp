...
namespace {
struct qt_meta_stringdata_WhatsProgNovaConversa_t {
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_WhatsProgNovaConversa_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_WhatsProgNovaConversa_t qt_meta_stringdata_WhatsProgNovaConversa = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_WhatsProgNovaConversa[] = {
...
Q_CONSTINIT const QMetaObject WhatsProgNovaConversa::staticMetaObject = { {
    ...
    qt_meta_stringdata_WhatsProgNovaConversa.offsetsAndSizes,
    qt_meta_data_WhatsProgNovaConversa,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_WhatsProgNovaConversa_t,
        // Q_OBJECT / Q_GADGET
...
void *WhatsProgNovaConversa::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_WhatsProgNovaConversa.stringdata0))
